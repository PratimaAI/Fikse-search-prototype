...
import app  # Your app file with FastAPI app
import re
import numpy as np
...
class TestSearchEngine(unittest.TestCase):
    ...
    def test_correct_query_spell_correction(self):
        ...
        corrected = app.correct_query(misspelled)
    ...
    def test_lemmatize_and_lower(self):
        ...
        normalized = app.lemmatize_and_lower(text)
        self.assertIsInstance(normalized, str)
        self.assertIn("shirt", normalized)
        self.assertIn("repair", normalized)

    def test_extract_price(self):
        self.assertEqual(app.extract_price("The price is 150 dollars"), 150)
        self.assertEqual(app.extract_price("Cost: 99"), 99)
        self.assertIsNone(app.extract_price("No price here"))
